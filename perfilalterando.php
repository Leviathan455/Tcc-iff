  ...
  <div class="container-fluid">
    ...
    <div class="perfil_conteiner">
      ...
      <div class="mostrainfo">
          <form action="#">
            <?php 
                echo "<h3> Nome: <input class='infos' type='text' value='".$Dados['Nome Completo']."'></h3>";
                echo "<h3> Email: <input class='infos' type='text' value='".$Dados['Email']."'></h3>"
            ?>
            <button class="salvaraltera"> Salvar Alterações</button>
